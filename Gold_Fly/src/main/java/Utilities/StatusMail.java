...
import TestLib.Driver;
	...
	public class StatusMail {
		...
		public static String to=Automation_properties.getInstance().getProperty("ReportEmail")+",test2097.test@gmail.com",cc="test2097.test@gmail.com",subject="FlyPegion Smoke Test Reports",attachmentPath="",attachmentPath1="";
		...
		public static void sendMail() throws Exception
		{
			...
			subject="FlyPegion Smoke Test Reports";
			System.out.println(Automation_properties.getInstance().getProperty("ReportEmail"));
		...
		{
			String userName="test2097.test@gmail.com";
			String passWord= "Test2097";
